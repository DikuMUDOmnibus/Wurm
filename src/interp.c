...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "map", 		do_map, 	POS_STANDING,    0,  LOG_NEVER,0},
    /*
...
/*  { "groups",		do_groups,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "immwho",         do_immwho,      POS_RESTING,    50,  LOG_NORMAL, 1 },
     ...
     */
    { "alia",		do_alia,	POS_DEAD,60,  LOG_NORMAL, 0 },
    { "alias",		do_alias,	POS_DEAD,60,  LOG_NORMAL, 1 },
    ...
    { "autoloot",	do_autoloot,	POS_DEAD,    60,  LOG_NORMAL, 1 },
    { "autosac",	do_autosac,	POS_DEAD,    60,  LOG_NORMAL, 1 },
...
/*  { "channels",	do_channels,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "outfit",		do_outfit,	POS_RESTING,60,  LOG_NORMAL, 1 },
    { "password",	do_password,	POS_DEAD,	 0,  LOG_NEVER,  1 },
    { "prompt",		do_prompt,	POS_DEAD,    60,  LOG_NORMAL, 1 },
    { "scroll",		do_scroll,	POS_DEAD,	 0,  LOG_NORMAL, 1 },
    { "title",		do_title,	POS_DEAD,	60,  LOG_NORMAL, 1},
    { "unalias",	do_unalias,	POS_DEAD,60,  LOG_NORMAL, 1 },
...
/*  { "music",		do_music,	POS_SLEEPING,	60,  LOG_NORMAL, 1 }, */
    ...
    { "pose",		do_pose,	POS_RESTING,	60,  LOG_NORMAL, 1},
    ...
    { "shout",		do_shout,	POS_RESTING,	60,  LOG_NORMAL, 1 },
    ...
    { "sacrifice",	do_sacrifice,	POS_RESTING,60,  LOG_NORMAL, 1 },
    { "junk",           do_sacrifice,   POS_RESTING, 60,  LOG_NORMAL, 0 },
    { "tap",      	do_sacrifice,   POS_RESTING, 60,  LOG_NORMAL, 0 },   
/*  { "unlock",		do_unlock,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, */
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    { "where",		do_where,	POS_RESTING,50,  LOG_NORMAL, 1 },
    ...
    { "reboot",		do_reboot,	POS_DEAD,	59,  LOG_ALWAYS, 1 },
...
/*  { "sockets",	do_sockets,	POS_DEAD,	60,  LOG_NORMAL, 1 }, */
    ...
    { "pardon",		do_pardon,	POS_DEAD,	54,  LOG_ALWAYS, 1 },
