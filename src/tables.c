...
const struct clan_type clan_table[MAX_CLAN] =
{
    ...
    {	"cult",	      "[{w CULT{x ] ",	ROOM_VNUM_ALTAR,        FALSE   },
    {	"guard",      "[{w GUARD{x ] ",	ROOM_VNUM_ALTAR,        FALSE  	},
    {   "base",       "",               ROOM_VNUM_ALTAR,        FALSE   },
    {   "hand",       "[{w HAND{x ] ",   ROOM_VNUM_ALTAR,        FALSE},
    {   "green",      "[{w GREEN {x] ", ROOM_VNUM_ALTAR,       FALSE   },
    {   "skull",      "[{w SKULL {x] ", ROOM_VNUM_ALTAR,        FALSE   }
};
...
const struct flag_type wear_flags[] =
{
    ...
    {  "sheathable",           ITEM_WEAR_BELT,         TRUE    },
