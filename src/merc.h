...
typedef struct	log_type		LOG_TYPE;
...
// defines for begining and end locker numbers
//
#define APT_START		0
#define APT_END			99
...
#define CON_MENU                        23
#define CON_GET_SHORTY			24
#define CON_GET_LONGY                   25
#define CON_ANSI			26
#define CON_GET_BACKY			27
...
/*
 * Structure to store list of last 10 players
 */
struct log_type
  {
    char 	*	log_name;
...
/*
 * bits for affectd2_by
 *
 */
#define AFF_GHOST		(A)
#define AFF_WBREATH	        (B)
...
#define OBJ_VNUM_SCHOOL_MACE	   1922
#define OBJ_VNUM_SCHOOL_DAGGER	   1920
#define OBJ_VNUM_SCHOOL_SWORD	   1921
#define OBJ_VNUM_SCHOOL_SPEAR	   1924
#define OBJ_VNUM_SCHOOL_STAFF	   1924
#define OBJ_VNUM_SCHOOL_AXE	   1920
#define OBJ_VNUM_SCHOOL_FLAIL	   1922
#define OBJ_VNUM_SCHOOL_WHIP	   1923
#define OBJ_VNUM_SCHOOL_POLEARM    1924

#define OBJ_VNUM_SCHOOL_VEST	   1909
#define OBJ_VNUM_SCHOOL_SHIELD	   1906
#define OBJ_VNUM_SCHOOL_BANNER     1906
#define OBJ_VNUM_MAP		   1906
...
//  level at which a skill could split into a new skill
...
struct	skill_type
{
    ...
    char * 	split_name;		/* Name of split skill		*/
    int		split_level;		/* Level where skill splits	*/
};
...
/* handler.c */
void 	init_player_log(LOG_TYPE * log,int head);
int 	add_log_entry(CHAR_DATA * ch, LOG_TYPE * log,int head);
void 	show_player_log(CHAR_DATA *ch, LOG_TYPE * log,int head);
