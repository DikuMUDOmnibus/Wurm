...
DECLARE_SPELL_FUN(      spell_ghost		);
DECLARE_SPELL_FUN(      spell_animate           );
DECLARE_SPELL_FUN(      spell_guards            );
DECLARE_SPELL_FUN(	spell_armor		);
DECLARE_SPELL_FUN(      spell_galamadriel       );
...
DECLARE_SPELL_FUN(      spell_true_path         );
DECLARE_SPELL_FUN(      spell_shadowpet         );
DECLARE_SPELL_FUN(      spell_poison_sense      );
DECLARE_SPELL_FUN(      spell_true_pain         );
DECLARE_SPELL_FUN(      spell_levitate          );
DECLARE_SPELL_FUN(      spell_astral_walk       );
DECLARE_SPELL_FUN(      spell_life_detect       );
DECLARE_SPELL_FUN(      spell_adrenalin         );
DECLARE_SPELL_FUN(      spell_mind_bar          );
DECLARE_SPELL_FUN(      spell_control_body      );
DECLARE_SPELL_FUN(      spell_drunken           );
DECLARE_SPELL_FUN(      spell_domination        );
DECLARE_SPELL_FUN(      spell_fireblast         );
DECLARE_SPELL_FUN(      spell_project_force     );
DECLARE_SPELL_FUN(      spell_complete_heal     );
DECLARE_SPELL_FUN(      spell_cell_adjust       );
DECLARE_SPELL_FUN(      spell_object_lore       );
