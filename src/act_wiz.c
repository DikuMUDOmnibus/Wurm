...
void do_wanted( CHAR_DATA *ch, char *argument )
{
    ...
    if ( arg1[0] == '\0' || arg2[0] == '\0' )
    {
	send_to_char( "Syntax: wanted <character> <killer/thief>.\n\r",ch);
	return;
    }
...
void do_mset( CHAR_DATA *ch, char *argument )
{
    ...
    if ( !str_prefix( arg2, "god" ) )
    {
        ...
        if( god == 0)
        {
        send_to_char("That is not a valid god.\n\r",ch);
        return;
        }
        victim->god = god;
        return;
    ...
    {
       send_to_char( "Mob couldnt locate.\n\r", ch);
       return;
    }
